...
- Be mindful not to engage in unnecessary physical contact with others.
    - Holding someone's hand or putting your arm around them without consent
...
- Avoid any language, behavior, or objectification that could make someone feel uncomfortable.
    - "It felt so dreary with just a bunch of guys, but now that there are women, it feels like a garden!"
    - Using slang like "Aang, g**chi" as an exclamation
- Do not touch other people's belongings without permission.
    - Cell phones, laptops, etc.
    - [Assistive devices](http://knat.go.kr/knw/home/knat_DB/my.html) (hearing aids, wheelchairs, etc.)
- Do not carry dangerous items.
    - Baseball bats, chemical substances, firearms, sharp objects, etc.
...
- Avoid gender-stereotyped language and behavior.
    - "That's just how men/women are."
    - Assuming a female developer is a front-end developer by saying, "You're a front-end developer, right?"
- Do not use sexual orientation, gender identity, or gender expression as a subject of jokes or derogatory comments.
    - "Are you gay?", "With hair that short, you look like a lesbian."
- Do not discriminate based on age, social status, or years of experience.
    - Speaking informally to someone you've just met just because they are younger
    - "You probably don't know this since you don't have many years of experience, but..."
...
- Avoid using racial or regional slurs or expressions based on nationality.
    - Using slurs based on nationality such as "J***," "C***," or similar
    - Using slurs based on race such as "Yankee," "banana," or "black dude"
    - Regional slurs like "J**ba," etc.
- Do not insult others' religions or political beliefs, and do not force your own beliefs onto others.
    - "People who follow [Religion] are a problem."
    - "People who support [Political Party] are a problem."
- Refrain from making unnecessary judgments or discriminatory comments about someone's appearance.
    - "You look like a developer" or "You don't look like a developer."
    - Referring to someone based on appearance, like "the pretty female developer."
...
- Do not make derogatory remarks about illnesses or disabilities.
    - Avoid using offensive terms for disabilities.
        - Terms like "blind," "one-eyed," "deaf," "mute," "cripple," etc.
        - "Are you disabled?" or "Do you seem mentally ill?"
    - "This legacy code is going to give me cancer."
- Do not make comments that force or disregard other people's dietary choices.
    - "If you don't drink, what joy is left in life?"
    - "For the sake of your health, you should eat meat."
...
- Do not make discriminatory remarks based on education or major.
    - "Did you only graduate high school?"
    - "As a non-major, you probably don't know about this."
...
- Do not spread unofficial information (e.g., rumors, hearsay) outside of official sources (such as the website, announcements, official SNS, or emails sent by PyCon Korea).
    - "My friend/acquaintance is on the PyCon Korea organizing committee, and they told me that…"